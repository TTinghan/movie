	...
	<script type="text/javascript">
		 function check(form1){
			/* if(form1.user.value=="0"){
				alert("请选择要登录的角色！");form.user.focus();
				return;
			} */
    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <input type="button" onclick="check(form1)" id="btn" class="button button-block bg-main text-big input-big" value="登录">
                <a href="/movie/adduser.jsp"><input type="button" id="btn_register" class="button button-block bg-main text-big input-big" value="注册">
               </a>
                </div>
